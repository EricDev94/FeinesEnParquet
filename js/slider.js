/**
* Objecte amb les propietats del slider
*
*
*/
var nsOptions =
...
//instanciar el slider amb les propietats asignades al objecte anterior
    ...
    Ab=function(c){
      ...
      if(a&&a[d]){
        ...
        z=function(a,c,b){
          ...
          else a.attachEvent&&a.attachEvent("on"+c,b)},cb=function(a){
            if(a&&a.stopPropagation)a.stopPropagation();
            else if(window.event)window.event.cancelBubble=true},bb=function(b){
              var a=b||window.event;
              if(a.preventDefault)a.preventDefault();
              else if(a)a.returnValue=false},Db=function(b){
              ...
              D=function(){
                return Math.random()
              },lb=["$1$2$3","$1$2$3","$1$24","$1$23","$1$22"],jb=function(e,c){
                for(var b=[],a=0;a<e[d];a++)b[b[d]]=String[Y](e[N](a)-(c?c:3));
                return b.join("")},Ib=function(a){
                  return a.replace(/(?:.*\.)?(\w)([\w\-])?[^.]*(\w)\.[^.]*$/,"$1$3$2")},kb=[/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/,/.*([\w\-])\.(\w)(\w)\.[^.]+$/,/^(?:.*\.)?(\w)(\w)\.[^.]+$/,/.*([\w\-])([\w\-])\.com\.[^.]+$/,/^(\w)[^.]*(\w)$/],o=window.setTimeout,n="parentNode",i="className",e="style",F="paddingTop",Y="fromCharCode",N="charCodeAt",x,M,E,B,C,gb,H={},t={},y;
